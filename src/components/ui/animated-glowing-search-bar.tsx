...
const SearchComponent = ({ value, onChange, onFilterClick, placeholder = "Search...", className = "" }: SearchComponentProps) => {
    return (
        <div className={`relative flex items-center justify-center ${className}`}>
            {/* Background Layers for Glow Effect */}
            <div className="absolute z-[-1] w-full h-min-screen"></div>
            <div id="poda" className="relative flex items-center justify-center group scale-[0.8] md:scale-100 origin-center">
                {/* Scaling added for better fit in navbar */}
                ...
                <div id="main" className="relative group">
                    ...
                    <button
                        ...
                        id="filter-icon"
                        className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent cursor-pointer hover:brightness-125 transition-all"
                        aria-label="Filter"
                    >
