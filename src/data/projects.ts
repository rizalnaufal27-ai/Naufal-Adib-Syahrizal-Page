...
export const projects: Project[] = [
    ...
    {
        id: 16,
        title: 'KULI-YEAH THE SERIES — Episode 2 "JAMKOS"',
        category: "Video Editing",
        image: "/images/portfolio/video-editing/jamkos.png",
        gradient: "linear-gradient(135deg, #111111, #333333)",
        tools: ["CapCut", "DaVinci Resolve", "Antigravity"],
        story: "Kelanjutan kisah seru para kuli yang makin gila di masa jam kosong perkuliahan. Projek ini fokus pada pacing komedi yang cepat dengan transisi dinamis untuk audiens TikTok.",
        media: ["/images/portfolio/video-editing/jamkos.png"],
        date: "2024",
        liveUrl: "https://vt.tiktok.com/ZSHKTxU7G/",
    },
    {
        id: 17,
        title: 'KULI-YEAH THE SERIES — Episode 4 "TOILET VS TIKTOK"',
        category: "Video Editing",
        image: "/images/portfolio/video-editing/toilet-vs-tiktok.png",
        gradient: "linear-gradient(135deg, #0f0f0f, #1a1a1a)",
        tools: ["CapCut", "DaVinci Resolve", "Antigravity"],
        story: "Finale season pertama yang mempertemukan tren TikTok absurd dengan komedi situasi di toilet. Menggunakan teknik editing visual gag yang kuat untuk memaksimalkan retensi penonton.",
        media: ["/images/portfolio/video-editing/toilet-vs-tiktok.png"],
        date: "2024",
        liveUrl: "https://vt.tiktok.com/ZSHKTuEdS/",
    },
];
