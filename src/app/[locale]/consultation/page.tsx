            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-8 shadow-2xl">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                        Get a Free Consultation <Sparkles className="text-yellow-400" size={20} />
                    </h1>
                    <p className="text-white/40 text-sm mb-8 leading-relaxed">
                        Tell me a bit about yourself and your project, and we'll instantly open a private chat room to discuss your needs.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-[10px] font-bold uppercase tracking-widest text-white/40 mb-2">Your Email</label>
                            <input
                                required
                                type="email"
                                value={form.email}
                        ...
                        <div>
                            <label className="block text-[10px] font-bold uppercase tracking-widest text-white/40 mb-2">Project Idea (Optional)</label>
                            <textarea
